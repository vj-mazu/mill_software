                          ...
                          <tr style={{ backgroundColor: '#1a237e', color: 'white' }}>
                            {isRiceMode ? (
                              ...
                              <>
                                ...
                                <th style={{ border: '1px solid #000', padding: '3px', fontWeight: '700', fontSize: '12px', textAlign: 'center', whiteSpace: 'normal', wordBreak: 'break-word', width: '3.5%' }}>Offer Rate</th>
                                  ...
                                  <>
                                    ...
                                    <td style={{ border: '1px solid #000', padding: '3px', textAlign: 'center' }}>
                                      {(isAdmin || isManager) ? (
                                        ...
                                        <button onClick={() => handleOpenOfferModal(entry)} style={{ fontSize: '10px', padding: '3px 6px', backgroundColor: o?.offerBaseRateValue ? '#3498db' : '#2196F3', color: 'white', border: 'none', borderRadius: '3px', cursor: 'pointer', fontWeight: '700', whiteSpace: 'nowrap' }}>
                                          {o?.offerBaseRateValue ? (
                                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', lineHeight: '1.15' }}>
                                              <span>{`Rs ${toNumberText(o.offerBaseRateValue)}`}</span>
                                              <span style={{ fontSize: '9px', fontWeight: 600, opacity: 0.95 }}>
                                    ...
                                    ) : <span>{o?.offerBaseRateValue ? `${toNumberText(o.offerBaseRateValue)} (${formatRateTypeLabel(o.baseRateType || entry.offering?.baseRateType || 'PD_WB')})` : '-'}</span>}
                                    </td>
                                    <td style={{ border: '1px solid #000', padding: '3px', textAlign: 'center' }}>
                                      {isAdmin ? (
