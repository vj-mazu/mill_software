                          ...
                          <tbody>
                            {orderedEntries.map((entry, index) => {
                              ...
                              const secondCookingAttempt = isResampleCase
                                ? deriveCookingAttempt(secondAttemptEvents, 2)
                                : null;
                              ...
                              const secondCookingResolved = normalizedLotDecision === 'PASS_WITHOUT_COOKING'
                                ? true
                              ...
                              const failedCookingLabel = failedCookingAttempt
                                ...
                                : '';
                              const qualityAttemptCount = isResampleCase ? 2 : 1;
                              const cookingAttemptCount = Math.max(1, cookingAttempts.length || 0);
                              ...
                              return (
                                <tr key={entry.id} style={{ background: rowBg }}>
                                  ...
                                  <td style={{ border: '1px solid #000', padding: '3px 5px', textAlign: 'left', fontSize: '14px', lineHeight: '1.35', wordBreak: 'break-word' }}>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                                      <button
                                        type="button"
                                        onClick={() => openDetailEntry(entry)}
                                  ...
                                  <td style={{ border: '1px solid #000', padding: '4px 5px', textAlign: 'left', fontSize: '10px', lineHeight: '1.2' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                                      {Array.from({ length: qualityAttemptCount }, (_, idx) => idx + 1).map((attemptNo) => {
                                         const attempt = qualityAttempts.find((item) => item.attemptNo === attemptNo);
                                         const isLatestAttempt = attemptNo === qualityAttemptCount;
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 0, width: '100%', border: '1px solid #000' }}>
                                      {Array.from({ length: cookingAttemptCount }, (_, idx) => idx + 1).map((attemptNo) => {
                                          ...
                                          const rawStatus = attempt?.status
                                            || (attemptNo === cookingAttemptCount ? 'Pending' : '-');
            ...
            <div style={editFormGridStyle}>
              <div style={editRateFieldStyle}>
                ...
                <div style={editRateRowStyle}>
                  ...
                  <select
                    ...
                    style={{ flex: 1, minWidth: '120px', padding: '7px 9px', border: '1px solid #27ae60', borderRadius: '6px', fontSize: '11px', cursor: 'pointer' }}
                  >
                    <option value="PD_WB">PD/WB</option>
                    <option value="PD_LOOSE">PD/Loose</option>
                    <option value="MD_WB">MD/WB</option>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Sute"
                  style={{ width: '100%', padding: '7px 9px', border: '1px solid #ccc', borderRadius: '6px', fontSize: '12px' }}
                />
                <div style={{ display: 'flex', gap: '6px', fontSize: '11px', marginTop: '4px' }}>
