...
const resolveQualitySmellInput = (body = {}, sampleEntry = {}, existingQuality = null) => {
...
const shouldCreateNewResampleQualityAttempt = (entry = {}) => {
  ...
  return isResampleWorkflowMarker(entry)
    ...
    upload.single('photo')(req, res, async (err) => {
      ...
      try {
        ...
        if (existingQuality) {
          ...
          const shouldCreateNewResampleAttempt = shouldCreateNewResampleQualityAttempt(sampleEntry || {});
